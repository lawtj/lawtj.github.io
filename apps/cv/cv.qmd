...
**Associate Professor** [July, 2025 – present]{.cvdate}<br>
University of California, San Francisco, Department of Anesthesiology & Perioperative Care

**Assistant Professor** [July, 2018 – July, 2025]{.cvdate}<br>
University of California, San Francisco, Department of Anesthesiology & Perioperative Care
...
**Associate Director of Research, Center for Health Equity in Surgery and Anesthesia** [2022 - 2025]{.cvdate}<br>
University of California, San Francisco

**Director of Research, Center for Global Surgical Studies** [2022 - 2025]{.cvdate}<br>

**Faculty Recruitment Committee, ZSFG** [2022 - 2025]{.cvdate}<br>
...
1. Hughes C, Chen D, **Law TJ**, et al. Pulse oximeter performance and skin pigment: Comparison of 34 oximeters using current and emerging regulatory frameworks. *Anesth Analg* 2026;10.
1. Corpman D, Lang E, **Law TJ**. Large language models in trauma anesthesia education. *Curr Opin Anaesthesiol* 2026;39(2):160–166.
1. Dundas NE, **Law T**, Brender T, et al. All that shines is not gold: Maintaining scientific rigor when evaluating, interpreting, and reviewing studies using large language models. *Anesthesiology* 2026;144(2):272–288.
1. **Law TJ**, Leeb G, van Wijk XMR, et al. Differences in arterial oxygen saturation measurements between two co-oximeters from different manufacturers. *Respir Care* 2025;70(12):1485–1493.
1. Elmankabadi S, Dove J, Behnke E, et al. Comparing pulse oximeter performance using a common functional tester versus controlled desaturation studies on healthy participants. *J Clin Monit Comput* 2025;1–12.
1. Fong N, Lipnick MS, Behnke E, Chou Y, Elmankabadi S, Ortiz L, et al. Open access dataset and common data model for pulse oximeter performance data. Sci Data 2025;12(1):570.
1. Nankabirwa V, Guma I, Kabunga J, Bigogo HC, Navume DE, Mwanje TK, **Law TJ**, et al. Acute trauma care training in undergraduate medical education programs in Uganda; A cross-sectional survey of final year medical students. *Afr J Emerg Med* 2025;15(2):602–606.
1. Leir, Sarah A., **Tyler J. Law**, and M. Dylan Bould. 2024. “The Anesthesia Human Resources Crisis in Canada.” *Journal Canadien d’anesthesie [Canadian Journal of Anaesthesia]* 71 (12): 1612–26.
...
::: {.flex-container}
[**International Anesthesia Research Society**]{.flex-left} [*Law (PI)*]{.flex-center} [08/2025 - 08/2027]{.flex-right}  
:::
**Funding amount:** $175,000 for FTE  
“Prediction of Pulse Oximeter Bias Using Machine Learning”  
**Role**: Principal Investigator (data analytics - developing machine learning models to predict pulse oximeter bias based on skin tone, perfusion, and other factors)

::: {.flex-container}
[**Burroughs Wellcome Fund - Innovation in Regulatory Science Award**]{.flex-left} [*Lipnick (PI)*]{.flex-center} [08/2025 - 08/2030]{.flex-right}  
:::
**Funding amount:** $500,000
"Advancing Methods to Inform Regulatory Action for Equitable Pulse Oximeter Performance"
**Role**: Co-Investigator (data analysis and validation)
...
**Role**: Key personnel (data analytics – dashboard reporting metrics, descriptive analysis, quality metrics, outlier investigation. )
...
**Role**: Key personnel (data analytics - managing data engineering pipeline, database structure, data cleaning, QI, and project support)
...
1. **Challenges in Global Surgical Workforce Assessment** *World Congress of Anaesthesia, Marrakech, Morocco, 2026* <a href="../artifacts/264-presentation-certificate-wca2026.pdf" target="_blank">↗</a>
1. **Anesthesia Workforce Measurement - Multidisciplinary Lessons Learned** *World Congress of Anaesthesia, Marrakech, Morocco, 2026* <a href="../artifacts/264-presentation-certificate-wca2026.pdf" target="_blank">↗</a>

1. **AI for the Medical and Health Researcher.** *Institute of Global Health Sciences, San Francisco, May 2026* <a href="https://www.youtube.com/watch?v=LqJrIwc5YEs" target="_blank">↗</a>
1. **Comparison of Objective and Subjective Tools for Assessing Skin Pigmentation Diversity.** *SPIE Photonics West, San Francisco, 2025*
...
1. **Pulse oximetry, health disparities & opportunities for data sharing.** *Anesthesia Critical Care Speaker Exchange Program. October, 2023.*
...
1. **The Global Anesthesia Workforce: Considerations for Measurement** *Global OHNS Initiative. June, 2020.*
...
1. **Quality Improvement in Anesthesia** *Grand Rounds, Toronto Western Hospital (Toronto), 2014*
1. **Global health and Anesthesia** *Grand Rounds, Sunnybrook Hospital (Toronto), 2014*
1. **Health Economics and Anesthesia** *Grand Rounds, Mt. Sinai Hospital (Toronto), 2014*
1. **Avoidable surgery: a novel health systems indicator** *Grand Rounds, Sunnybrook Hospital (Toronto), 2016*
1. **Beyond Oxygen Bias** *UCSF Anesthesia Grand Rounds, 2025*
1. **Bias and Fairness in Data Science** *UCSF Anesthesia Grand Rounds, 2025*
1. **Code Blues - From Algorithm to Physiology** *ZSFG RN Education Day, 2026*

## Abstracts


**Examination of sex-linked differences in resting SpO2 and SaO2 in healthy adults.** Yu (Celine) Chou, Danni Chen, Ella Behnke, Lily Ortiz, René Vargas Zamora, John Feiner, Tyler Law, Philip Bickler, Carolyn Hendrickson, Fekir Negussie, Michael S. Lipnick. *American Thoracic Society, San Francisco, CA, 2025*
...
**Rideshare-Based Transportation Services for Pre- and Post-Operative Surgical patients in an Urban Setting: A Descriptive Analysis of a Quality Initiative Program.** Miclau, Theodore A., Daniel J. Bennett, Laura Lang, Megha Parekh, and **Tyler Law**. UCSF FCM Colloquium, San Francisco, CA, 2022.
...
**First Place, Editor's Choice Category, Anesthesia & Analgesia** [March, 2025]{.cvdate}<br>
For the paper: "The Global Anesthesia Workforce Survey: Updates and Trends in the Anesthesia Workforce"
...
1. **Mina Sarofim (2025-2026):** Mentor for UCSF Medical School Deep Explore project, continuing work on factors associated with anesthesia residents in rural areas. 
1. **Ashley Cao (2026-Present):** Mentor for Touro Medical Student project on computer vision and vital sign recognition.
...
| --- | --- | --- |
| Respiratory Care | 2 | 2026 |
| British Journal of Anaesthesia | 1 | 2026 |
| BMJ Global Health | 1 | 2026 |
| Journal of International Medical Research | 1 | 2026 |
| Respiratory Care | 1 | 2025 |
| CMAJ | 1 | 2025 |
| BMC Anesthesiology | 1 | 2025 |
| European Journal of Medical Research | 1 | 2025 |
| Scientific Data | 1 | 2025 |
| BMC Nursing | 1 | 2025 |
| BMC Health Services Research | 1 | 2025 |
| JAMA | 1 | 2025 |
